...
class _CheckoutPageState extends State<CheckoutPage> {
        ...
        child: WebView(
          ...
          navigationDelegate: (NavigationRequest request) {
            ...
            if (request.url.startsWith('https://success.com')) {
              ...
              makeToast("Stripe payment failed , please try again/later", context, Colors.red);
              api.stripeCallBackTransactionIdAndStatus(
                  transactionId: widget.transactionId,
  ...
  String get initialUrl =>
      'https://hostedpages.sevengps.net/#/mobileStripe?publishKey=${widget.publishKey}&sessionID=${widget.sessionId}';
...
''';
    ...
    try {
      ...
      if (!e.details.contains('JavaScript execution returned a result of an unsupported type')) {
        makeToast("Something went wrong , please try again or later", context, Colors.red);
        rethrow;
      }
    }
  }
